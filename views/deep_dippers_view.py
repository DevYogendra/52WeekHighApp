...
def main():
    ...
    st.caption("Distressed or deep-value triage. Use this page to separate cheap-looking names from genuinely improving businesses.")
    ...
    with grouped_tab:
        ...
        selected_group_industry = st.selectbox("Grouped industry", grouped_industries, key="deep_dippers_grouped_industry")
        ...
        render_interactive_table(
            ...
            key=f"deep_dippers_group_{selected_group_industry}",
            rename_map=COMMON_RENAME_MAP,
    ...
    st.download_button(
        ...
        file_name=f"big_dippers_{date_info.replace(' ', '_').replace('to', '-')}.csv",
    )
